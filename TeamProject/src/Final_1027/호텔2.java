	...
	public void 예약등록(int hotelch, int roomch, String h_id) {
		if (roomch == 1) {
			if (room[hotelch - 1][roomch - 1] == null) {
				System.err.println(" [[예약 완료]] : 라마다호텔 / 스위트룸 ");
			...
			if (room[hotelch - 1][roomch - 1] == null) {
				System.err.println(" [[예약 완료]] : 라마다호텔 / 디럭스룸 ");
				room[hotelch - 1][roomch - 1] = h_id;
			...
			if (room[hotelch - 1][roomch - 1] == null) {
				System.err.println(" [[예약 완료]] : 라마다호텔 / 스탠다드룸 ");
				room[hotelch - 1][roomch - 1] = h_id;
	...
	public void 예약취소(int hotelch, int roomch, String h_id) {
		if (roomch == 1) {
			if (room[hotelch - 1][roomch - 1].equals(h_id)) {
				System.err.println(" [[예약 취소]] : 라마다호텔 / 스위트룸 ");
			...
			if (room[hotelch - 1][roomch - 1].equals(h_id)) {
				System.err.println(" [[예약 취소]] : 라마다호텔 / 디럭스룸 ");
				room[hotelch - 1][roomch - 1] = null;
			...
			if (room[hotelch - 1][roomch - 1].equals(h_id)) {
				System.err.println(" [[예약 취소]] : 라마다호텔 / 스탠다드룸 ");
				room[hotelch - 1][roomch - 1] = null;
	...
	public void 본인예약조회(String h_id) {
		...
		for (int i = 0; i < 3; i++) {
			if (room[1][i] != null && room[1][i].equals(h_id)) {
				if (i == 0) {
					System.out.println(" *** 라마다호텔 / 스위트룸 " + room[1][i] + " 님 예약 *** ");
				} else if (i == 1) {
					System.out.println(" *** 라마다호텔 / 디럭스룸 " + room[1][i] + " 님 예약 *** ");
				} else if (i == 2) {
					System.out.println(" *** 라마다호텔 / 스탠다드룸 " + room[1][i] + " 님 예약 *** ");
				}
